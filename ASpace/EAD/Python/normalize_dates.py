...
path = '/users/pjameskelly/desktop/XML_Normalized_2' #<-- Change this to your EAD directory path
...
for filename in os.listdir(path):
    ...
    outfilepath = '/users/pjameskelly/desktop/XML_Normalized_2' #<-- Change this to a different directory than the one you started with in case anything goes wrong. You don't want to overwrite your original EADs.
