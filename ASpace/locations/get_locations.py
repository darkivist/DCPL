...
def make_row(data):
	...
	row.append(data['coordinate_3_label'] if 'coordinate_3_label' in data else '')
	row.append(data['coordinate_3_indicator'] if 'coordinate_3_indicator' in data else '')
	row.append(data['uri'])
	writer.writerow(row)

def main():
	column_headings = ['building','floor','room','coordinate_1_label','coordinate_1_indicator','coordinate_2_label','coordinate_2_indicator','coordinate_3_label','coordinate_3_indicator','uri']
